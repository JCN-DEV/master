 ...
 */
public interface InstituteStatusRepository extends JpaRepository<InstituteStatus, Long> {
    ...
    @Query("select instituteStatus from InstituteStatus instituteStatus where instituteStatus.institute.user.login = ?#{principal.username}")
    InstituteStatus findOneByCurrentInstitute();

    @Query("select instituteStatus from InstituteStatus instituteStatus where instituteStatus.institute.id = :id")
    InstituteStatus findOneByInstitute(@Param("id") Long id);
}
