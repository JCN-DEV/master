...
import gov.step.app.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("gov.step.app.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("gov.step.app.repository.search")
