...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "step@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "step API";

        private String description = "step API documentation";
    ...
    public static class Social {
        ...
        private String redirectAfterSignIn = "/#/dashboard";
