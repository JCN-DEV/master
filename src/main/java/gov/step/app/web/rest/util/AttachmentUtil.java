...
public class AttachmentUtil {
    ...
    public static String saveDlAttachment(String filepath,String attachmentName,String extension, byte[] file) throws Exception{
        String filename=attachmentName+getDateForFileName()+extension;
        File outputFile=new File(filepath+filename);
        FileOutputStream out = new FileOutputStream(outputFile);
        out.write(file);
        out.close();
    ...
    public static String saveRisAttachment(String filepath,String attachmentName,String extension, byte[] file) throws Exception{
        String filename = attachmentName + getDateForFileName() + extension;
        File outputFile=new File(filepath + filename);
        FileOutputStream out = new FileOutputStream(outputFile);
        out.write(file);
    ...
    public static String saveRisApplicant(String filepath,String attachmentName,String extension, byte[] file) throws Exception{
        String filename = attachmentName + getDateForFileName() + extension;
        File outputFile=new File(filepath + filename);
        FileOutputStream out = new FileOutputStream(outputFile);
        out.write(file);
