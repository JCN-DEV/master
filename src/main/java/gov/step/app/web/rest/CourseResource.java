...
import gov.step.app.repository.CourseRepository;
import gov.step.app.repository.search.CourseSearchRepository;
...
public class CourseResource {
     ...
     */
    @RequestMapping(value = "/courses", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    ...
    @Timed
    public ResponseEntity<List<Course>> getAllCourses(Pageable pageable) throws URISyntaxException {
     ...
     */
    @RequestMapping(value = "/courses/{id}", method = RequestMethod.DELETE, produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    ...
    /**
     * SEARCH /_search/courses/:query -> search for the course corresponding to
     * the query.
     */
    @RequestMapping(value = "/_search/courses/{query}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
