...
public class EmployeeResource {
     ...
     */
    @RequestMapping(value = "/employees/my",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Employee> getMyEmployee() {
        return Optional.ofNullable(employeeRepository.findOneByEmployeeUserIsCurrentUser())
    ...
    /**
     * GET  /employees/institute/:id -> get the all employee by institute.
     */
    @RequestMapping(value = "/employees/institute/{id}",
        method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed

    public List<Employee> getAllEmployeeByInstitute(@PathVariable Long id)
        throws URISyntaxException {
        List<Employee> employees = employeeRepository.findByEmployee(id);
        return  employees;
