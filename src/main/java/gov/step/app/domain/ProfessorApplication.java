...
/**
 * A ProfessorApplication.
 */
@Entity
@Table(name = "professor_application")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "professorapplication")
public class ProfessorApplication implements Serializable {

    @Id
    @GeneratedValue(strategy=GenerationType.AUTO, generator="prof_app_seq")
    @SequenceGenerator(name="prof_app_seq", sequenceName="prof_app_seq")
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        ProfessorApplication professorApplication = (ProfessorApplication) o;

        if ( ! Objects.equals(id, professorApplication.id)) return false;
