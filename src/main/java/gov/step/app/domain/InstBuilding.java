 ...
 */
@Entity
@Table(name = "inst_building")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "instbuilding")
public class InstBuilding implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        InstBuilding instBuilding = (InstBuilding) o;

        if ( ! Objects.equals(id, instBuilding.id)) return false;
