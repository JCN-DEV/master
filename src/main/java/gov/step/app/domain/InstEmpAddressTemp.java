...
/**
 * A InstEmpAddressTemp.
 */
@Entity
@Table(name = "inst_emp_address_temp")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "instempaddresstemp")
public class InstEmpAddressTemp implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        InstEmpAddressTemp instEmpAddressTemp = (InstEmpAddressTemp) o;

        if ( ! Objects.equals(id, instEmpAddressTemp.id)) return false;
