 ...
 */
@Entity
@Table(name = "dl_cont_cat_set")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "dlcontcatset")
public class DlContCatSet implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        DlContCatSet dlContCatSet = (DlContCatSet) o;

        if ( ! Objects.equals(id, dlContCatSet.id)) return false;
