 ...
 */
@Entity
@Table(name = "hr_employee_info_log")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "hremployeeinfolog")
public class HrEmployeeInfoLog implements Serializable {
    ...
    @Column(name = "apointment_go_date")
    ...
    public byte[] getQuotaCert() {return quotaCert;}

    public void setQuotaCert(byte[] quotaCert) {this.quotaCert = quotaCert;}

    public String getQuotaCertContentType() {return quotaCertContentType;}

    public void setQuotaCertContentType(String quotaCertContentType) {this.quotaCertContentType = quotaCertContentType;}

    public String getQuotaCertName() {return quotaCertName;}

    public void setQuotaCertName(String quotaCertName) {this.quotaCertName = quotaCertName;}
    ...
    public boolean equals(Object o) {
        ...
        HrEmployeeInfoLog hrEmployeeInfoLog = (HrEmployeeInfoLog) o;
        return Objects.equals(id, hrEmployeeInfoLog.id);
    }
    ...
    public String toString() {
        return "HrEmployeeInfoLog{" +
            ...
            ", religion='" + religion + "'" +
            ", empPhoto='" + empPhoto + "'" +
            ", empPhotoContentType='" + empPhotoContentType + "'" +
            ", imageName='" + imageName + "'" +
