 ...
 */
@Entity
@Table(name = "inst_aca_info")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "instacainfo")
public class InstAcaInfo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        InstAcaInfo instAcaInfo = (InstAcaInfo) o;

        if ( ! Objects.equals(id, instAcaInfo.id)) return false;
