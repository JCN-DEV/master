 ...
 */
@Entity
@Table(name = "inst_land_temp")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "instlandtemp")
public class InstLandTemp implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        InstLandTemp instLandTemp = (InstLandTemp) o;

        if ( ! Objects.equals(id, instLandTemp.id)) return false;
    ...
    public String toString() {
        return "InstLandTemp{" +
            ...
            ", distncFromDistHQ='" + distncFromDistHQ + '\'' +
            ", distncFromMainRd='" + distncFromMainRd + '\'' +
            ", height='" + height + '\'' +
            ", width='" + width + '\'' +
