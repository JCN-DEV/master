...
angular.module('stepApp').controller('HrEmpForeignTourInfoDialogController',
    ['$scope', '$rootScope', '$sce', '$stateParams', '$state', 'DataUtils', 'entity', 'HrEmpForeignTourInfo', 'HrEmployeeInfoByWorkArea', 'MiscTypeSetupByCategory','User','Principal','DateUtils',
        function($scope,  $rootScope, $sce, $stateParams, $state, DataUtils, entity, HrEmpForeignTourInfo, HrEmployeeInfoByWorkArea, MiscTypeSetupByCategory, User, Principal, DateUtils) {
