    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('umracActionSetup', {
                ...
                views: {
                    'umracManagementView@umrac': {
                        templateUrl: 'scripts/app/entities/umrac/umracActionSetup/umracActionSetups.html',
            ...
            .state('umracActionSetup.detail', {
                ...
                views: {
                    'umracManagementView@umrac': {
                        templateUrl: 'scripts/app/entities/umrac/umracActionSetup/umracActionSetup-detail.html',
            ...
            .state('umracActionSetup.new', {
                ...
                views: {
                    'umracManagementView@umrac': {
                        templateUrl: 'scripts/app/entities/umrac/umracActionSetup/umracActionSetup-dialog.html',
