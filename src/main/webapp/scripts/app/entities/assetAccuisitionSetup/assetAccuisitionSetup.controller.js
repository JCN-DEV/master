...
angular.module('stepApp')
    ...
    ['$scope', 'AssetAccuisitionSetup', 'AssetAccuisitionSetupSearch', 'ParseLinks',
    function ($scope, AssetAccuisitionSetup, AssetAccuisitionSetupSearch, ParseLinks) {
        $scope.assetAccuisitionSetups = [];
        $scope.page = 0;
        $scope.loadAll = function() {
            AssetAccuisitionSetup.query({page: $scope.page, size: 20}, function(result, headers) {
