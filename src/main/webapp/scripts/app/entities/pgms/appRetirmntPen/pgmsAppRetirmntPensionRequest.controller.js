...
angular.module('stepApp')
    ...
    ['$scope', '$state','$sce','$rootScope', '$timeout', 'DataUtils','PgmsAppRetirmntPen','PgmsAppRetirementPending','RetirementNomineeInfosByPenId','PgmsAppRetirementAttachByTypeAndPen','Principal', 'DateUtils',
    function($scope, $state, $sce, $rootScope, $timeout, DataUtils, PgmsAppRetirmntPen,  PgmsAppRetirementPending, RetirementNomineeInfosByPenId ,PgmsAppRetirementAttachByTypeAndPen,Principal, DateUtils)
    {
        ...
        $scope.loadAll = function()
        {
            ...
            $scope.newRequestList = [];
            PgmsAppRetirementPending.get({statusType:'Pending'},function(result) {
        ...
        $scope.loadApprovedRejectList = function ()
        {
            $scope.approvedList = [];
            $scope.rejectedList = [];
            PgmsAppRetirementPending.get({statusType:'Approved'},function(result) {
            ...
            PgmsAppRetirementPending.get({statusType:'Reject'},function(result) {
