        ...
        angular.module('stepApp')
            .controller('ApListController',
             ['$scope', 'entity', '$state', '$modal', 'TimeScaleApplication', 'TimescaleApplicationList', 'MpoApplication', 'Employee', 'Institute' ,'EmployeeSearch', 'EmployeeInstitute', 'ParseLinks', 'MpoApplicationLogEmployeeCode' , 'MpoApplicationInstitute','MpoApplicationList','APcaleApplicationList','Principal','InstLevelByName','APscaleSummaryList','APApplicationsByLevel',
             function ($scope, entity, $state, $modal, TimeScaleApplication, TimescaleApplicationList, MpoApplication, Employee, Institute ,EmployeeSearch, EmployeeInstitute, ParseLinks, MpoApplicationLogEmployeeCode , MpoApplicationInstitute,MpoApplicationList,APcaleApplicationList,Principal,InstLevelByName,APscaleSummaryList,APApplicationsByLevel) {
                ...
                $scope.currentPage = 1;
                $scope.pageSize = 10;
                /*APcaleApplicationList.query({status:1,page: $scope.page, size: 100}, function(result, headers) {
                    // $scope.pendingApplications = result;
                    console.log(result);
                });
                APcaleApplicationList.query({status:0,page: $scope.page, size: 100}, function(result, headers) {
                    // $scope.pendingApplications = result;
                    console.log(result);
                });*/
                /*APcaleApplicationList.query({page: $scope.page, size: 100}, function(result, headers) {
