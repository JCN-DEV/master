...
angular.module('stepApp')
    .controller('PrincipalPayCodeAssignController',
     ['$scope', 'entity', '$state','$stateParams', 'InstEmployee', 'MpoApplication', 'PayScale','ProfessorApplication','InstEmplPayscaleHist',
     function ($scope, entity, $state,$stateParams, InstEmployee, MpoApplication, PayScale,ProfessorApplication,InstEmplPayscaleHist) {
        ...
        $scope.save = function () {
           ...
           PayScale.get({id: $scope.payScaleID}, function(result) {
              ...
              InstEmplPayscaleHist.save($scope.instEmplPayscaleHist);
               $state.go('mpo.principalpayCodePendingList',{},{reload:true});
           });
