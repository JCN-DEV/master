...
angular.module('stepApp')
    .controller('BedPayCodeAssignController',
     ['$scope', 'entity', '$state','$stateParams', 'InstEmployee', 'MpoApplication', 'PayScale','BEdApplication','InstEmplPayscaleHist',
     function ($scope, entity, $state,$stateParams, InstEmployee, MpoApplication, PayScale,BEdApplication,InstEmplPayscaleHist) {
