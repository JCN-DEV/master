...
angular.module('stepApp')
    ...
    ['$scope', 'entity', '$state','$stateParams', 'InstEmployee', 'MpoApplication', 'PayScale','APScaleApplication','InstEmplPayscaleHist',
    function ($scope, entity, $state,$stateParams, InstEmployee, MpoApplication, PayScale,APScaleApplication,InstEmplPayscaleHist) {
