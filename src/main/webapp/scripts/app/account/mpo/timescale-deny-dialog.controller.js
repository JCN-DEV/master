...
angular.module('stepApp')
    .controller('TimescaleDenyDialogController',
     ['$scope','MpoApplication','TimeScaleApplication','TimeScaleApplicationStatusLog', 'entity', 'DateUtils', '$state', '$modalInstance', 'MpoApplicationStatusLog','TimescaleApplicationDecline','$stateParams',
     function ($scope,MpoApplication,TimeScaleApplication,TimeScaleApplicationStatusLog, entity, DateUtils, $state, $modalInstance, MpoApplicationStatusLog,TimescaleApplicationDecline,$stateParams) {
