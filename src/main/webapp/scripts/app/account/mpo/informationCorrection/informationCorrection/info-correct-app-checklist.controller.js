...
angular.module('stepApp')
    ...
    ['$scope', '$rootScope', '$state', '$stateParams', 'Sessions', 'InstEmployeeCode','InfoCorrectLogsByEmpCode', 'Principal',
    function ($scope, $rootScope, $state, $stateParams, Sessions, InstEmployeeCode,InfoCorrectLogsByEmpCode, Principal) {
...
*/
        InfoCorrectLogsByEmpCode.query({'code':$stateParams.code}, function(result) {
            console.log(result);
            $scope.infoCorrectionlogs = result;
            $scope.infoCorrection = result[0].informationCorrection;
