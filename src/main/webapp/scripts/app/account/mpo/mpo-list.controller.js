...
angular.module('stepApp')
    ...
    ['$scope', '$state', '$modal', 'Principal', 'MpoApplication', 'MpoCommitteeDescisionByLogin','Employee', 'Institute' ,'EmployeeSearch', 'EmployeeInstitute', 'ParseLinks', 'MpoApplicationInstitute','MpoApplicationList',
    function ($scope, $state, $modal, Principal, MpoApplication, MpoCommitteeDescisionByLogin,Employee, Institute ,EmployeeSearch, EmployeeInstitute, ParseLinks, MpoApplicationInstitute,MpoApplicationList) {
