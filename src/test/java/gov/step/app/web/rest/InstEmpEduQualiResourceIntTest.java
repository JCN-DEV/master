...
@WebAppConfiguration
@IntegrationTest
public class InstEmpEduQualiResourceIntTest {
    ...
    private static final String DEFAULT_GROUP_SUBJECT = "AAAAA";
    private static final String UPDATED_GROUP_SUBJECT = "BBBBB";

    private static final LocalDate DEFAULT_RESULT_PUBLISH_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_RESULT_PUBLISH_DATE = LocalDate.now(ZoneId.systemDefault());
    ...
    public void initTest() {
        ...
        instEmpEduQuali.setGroupSubject(DEFAULT_GROUP_SUBJECT);
        instEmpEduQuali.setResultPublishDate(DEFAULT_RESULT_PUBLISH_DATE);
    }
    ...
    public void createInstEmpEduQuali() throws Exception {
        ...
        assertThat(testInstEmpEduQuali.getGroupSubject()).isEqualTo(DEFAULT_GROUP_SUBJECT);
        assertThat(testInstEmpEduQuali.getResultPublishDate()).isEqualTo(DEFAULT_RESULT_PUBLISH_DATE);
    }
    ...
    public void getAllInstEmpEduQualis() throws Exception {
        ...
        restInstEmpEduQualiMockMvc.perform(get("/api/instEmpEduQualis"))
                ...
                .andExpect(jsonPath("$.[*].groupSubject").value(hasItem(DEFAULT_GROUP_SUBJECT.toString())))
                .andExpect(jsonPath("$.[*].resultPublishDate").value(hasItem(DEFAULT_RESULT_PUBLISH_DATE.toString())));
    }
    ...
    public void getInstEmpEduQuali() throws Exception {
        ...
        restInstEmpEduQualiMockMvc.perform(get("/api/instEmpEduQualis/{id}", instEmpEduQuali.getId()))
            ...
            .andExpect(jsonPath("$.groupSubject").value(DEFAULT_GROUP_SUBJECT.toString()))
            .andExpect(jsonPath("$.resultPublishDate").value(DEFAULT_RESULT_PUBLISH_DATE.toString()));
    }
    ...
    public void updateInstEmpEduQuali() throws Exception {
        ...
        instEmpEduQuali.setGroupSubject(UPDATED_GROUP_SUBJECT);
        instEmpEduQuali.setResultPublishDate(UPDATED_RESULT_PUBLISH_DATE);
        ...
        assertThat(testInstEmpEduQuali.getGroupSubject()).isEqualTo(UPDATED_GROUP_SUBJECT);
        assertThat(testInstEmpEduQuali.getResultPublishDate()).isEqualTo(UPDATED_RESULT_PUBLISH_DATE);
    }
