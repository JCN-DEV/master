...
public class CatResourceIntTest {
    ...
    public void initTest() {
        ...
        cat.setDescription(DEFAULT_DESCRIPTION);
        cat.setStatus(DEFAULT_STATUS);
    }
    ...
    public void createCat() throws Exception {
        ...
        assertThat(testCat.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testCat.getStatus()).isEqualTo(DEFAULT_STATUS);
    }
    ...
    public void updateCat() throws Exception {
        ...
        cat.setDescription(UPDATED_DESCRIPTION);
        cat.setStatus(UPDATED_STATUS);
        ...
        assertThat(testCat.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testCat.getStatus()).isEqualTo(UPDATED_STATUS);
    }
