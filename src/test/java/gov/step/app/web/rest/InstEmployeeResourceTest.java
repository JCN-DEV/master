...
@WebAppConfiguration
@IntegrationTest
public class InstEmployeeResourceTest {
...
private static final bloodGroup DEFAULT_BLOOD_GROUP = bloodGroup.A_POSITIVE;
    ...
    public void initTest() {
        ...
        instEmployee.setCode(DEFAULT_CODE);
    }
    ...
    public void createInstEmployee() throws Exception {
        ...
        assertThat(testInstEmployee.getCode()).isEqualTo(DEFAULT_CODE);
    }
    ...
    public void updateInstEmployee() throws Exception {
        ...
        instEmployee.setCode(UPDATED_CODE);
        ...
        assertThat(testInstEmployee.getCode()).isEqualTo(UPDATED_CODE);
    }
