...
@WebAppConfiguration
@IntegrationTest
public class InstFinancialInfoTempResourceIntTest {
...
private static final accountType DEFAULT_ACCOUNT_TYPE = accountType.General_Fund;
    ...
    public void initTest() {
        ...
        //instFinancialInfoTemp.setCreateDate(DEFAULT_CREATE_DATE);
        //instFinancialInfoTemp.setUpdateDate(DEFAULT_UPDATE_DATE);
    ...
    public void createInstFinancialInfoTemp() throws Exception {
        ...
        //assertThat(testInstFinancialInfoTemp.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
        //assertThat(testInstFinancialInfoTemp.getUpdateDate()).isEqualTo(DEFAULT_UPDATE_DATE);
    ...
    public void updateInstFinancialInfoTemp() throws Exception {
        ...
        //instFinancialInfoTemp.setCreateDate(UPDATED_CREATE_DATE);
        //instFinancialInfoTemp.setUpdateDate(UPDATED_UPDATE_DATE);
        ...
        //assertThat(testInstFinancialInfoTemp.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
        //assertThat(testInstFinancialInfoTemp.getUpdateDate()).isEqualTo(UPDATED_UPDATE_DATE);
